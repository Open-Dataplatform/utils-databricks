...
def handle_feedback_result(df_min_max: DataFrame, view_name: str, helper=None) -> str:
    """
...
def generate_feedback_timestamps(spark, view_name, feedback_column, helper=None) -> str:
    """
    ...
    return handle_feedback_result(df_min_max, view_name, helper)